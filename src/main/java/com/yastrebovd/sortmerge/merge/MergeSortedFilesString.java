...
@Slf4j
public class MergeSortedFilesString extends MergeSortedFiles<String> {
    public MergeSortedFilesString(Converter<String> converter, boolean isRevers) {
        super(converter, isRevers);
    }

    @Override
    public void mix(String fileName1, String fileName2, String out) {
